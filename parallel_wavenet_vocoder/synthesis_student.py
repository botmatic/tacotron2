...
from .audio import get_hop_size
...
def wavegen(model, c=None, g=None, fast=False, tqdm=tqdm):
    ...
    Args:
        ...
        g (scaler): Speaker ID
        fast (bool): unsused, for compatibility with the teacher interface
    Returns:
    ...
    with torch.no_grad():
        ...
        # y_hat = model(z, c=c, g=g, softmax=True)
